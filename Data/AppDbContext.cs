    ...
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TaskAssignment>()
                ...
                .OnDelete(DeleteBehavior.Restrict); // Prevent deleting Trainee if assignments exist
            ...
            // 2. Submission Relationships
            modelBuilder.Entity<Submission>()
                .HasOne(s => s.TaskAssignment)
                .WithMany(ta => ta.Submissions)
                .HasForeignKey(s => s.TaskAssignmentId)
                .OnDelete(DeleteBehavior.Cascade); // If an assignment is deleted, drop the submission
            ...
            modelBuilder.Entity<Review>()
                ...
                .OnDelete(DeleteBehavior.Cascade); // If a submission is deleted, drop the review

            modelBuilder.Entity<Review>()
                .HasOne(r => r.Mentor)
                .WithMany(m => m.Reviews)
                .HasForeignKey(r => r.MentorId)
                .OnDelete(DeleteBehavior.Restrict); // Prevent deleting Mentor if they have authored reviews
